...
<head>
    ...
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/bootstrap-3.min.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/jquery.gritter.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/jquery-ui.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/unicorn.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/custom.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/datepicker.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/bootstrap-select.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/select2.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/font-awesome.min.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/jquery.loadmask.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/token-input-facebook.css?14.4" media="all" />
    <link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/KeyTips.min.css?14.4" media="all" />
    <script type="text/javascript">
        var SITE_URL= "<?php echo base_url();?>index.php";
    </script>

    <script src="<?php echo base_url();?>js/all.js?14.4" type="text/javascript" language="javascript" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            setInterval(function(){$.get('<?php echo base_url();?>index.php/home/keep_alive');}, 300000);
        });
    </script>
...
<div id="wrapper"  >
    <div id="header" class="hidden-print">
        <h1><a href="<?php echo base_url();?>index.php/home"><img src="<?php echo base_url();?>img/header_logo.png" class="hidden-print header-log" id="header-logo" alt=""/></a></h1>
    ...
    <div id="sidebar" class="hidden-print minibar ">
        ...
        <ul>
            <li  ><a href="<?php echo base_url();?>index.php/home"><i class="icon fa fa-dashboard"></i><span class="hidden-minibar">Dashboard</span></a></li>
            <li class="active"><a href="<?php echo base_url();?>index.php/admin/sub_admin"><i class="fa fa-group"></i><span class="hidden-minibar">Sub Admins</span></a></li>
            <li ><a href="<?php echo base_url();?>index.php/admin/data_logger"><i class="fa fa-table"></i><span class="hidden-minibar">Data Logger</span></a></li>
    ...
    <div id="content"  class="clearfix " >
        ...
        <script type="text/javascript">
            $(document).ready(function()
            {
                var table_columns = ['','phppos_people'+'.person_id','last_name','first_name','email','phone_number'];
                enable_sorting("<?php echo base_url();?>index.php/customers/sorting",table_columns, 20, "last_name", "asc");
                enable_select_all();
                enable_checkboxes();
                enable_row_selection();
                enable_search('<?php echo base_url();?>index.php/customers/suggest',"You have selected one or more rows, these will no longer be selected after your search. Are you sure you want to submit this search?");
                enable_email('<?php echo base_url();?>index.php/customers/mailto');
                enable_delete("Are you sure you want to delete the selected customers?","You have not selected any customers to delete");
                enable_cleanup("Are you sure you want to clean ALL deleted customers? (This will remove account numbers from deleted customers so they can be reused)");
        ...
        <div id="breadcrumb" class="hidden-print">
            <a href="<?php echo base_url();?>index.php/admin/home"><i class="fa fa-home"></i> Dashboard</a><a  class="current" href="<?php echo base_url();?>index.php/customers">Customers</a>
        </div>
        <div class="clear"></div>
            ...
            <div class="row">
                <div class="col-md-12 center" style="text-align: center;">
                    <div class="btn-group  ">
                        ...
                        <a href="<?php echo base_url();?>index.php/customers/view/-1" id="new-person-btn" class="btn btn-primary" title="New Customer"><i title="New Customer" class="fa fa-pencil tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg"><?php echo $add;?></span></a>				<a class="btn btn-primary disabled email email_inactive" title="E-Mail" id="email" href="<?php echo base_url();?>index.php/customers#" >
                            <i title="E-Mail" class="fa fa-envelope tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">E-Mail</span>
                        </a>

                        <a href="<?php echo base_url();?>index.php/customers/excel_import" class="btn hidden-xs btn-primary " title="Excel Import"><i title="Excel Import" class="fa fa-upload tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">Excel Import</span></a>

                        <a href="<?php echo base_url();?>index.php/customers/excel_export" class="btn hidden-xs btn-primary  import" title="Excel Export"><i title="Excel Export" class="fa fa-download tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">Excel Export</span></a>										<a href="<?php echo base_url();?>index.php/customers/delete" id="delete" class="btn btn-danger disabled delete_inactive " title="Delete"><i title="Delete" class="fa fa-trash-o tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">Delete</span></a>																		<a href="<?php echo base_url();?>index.php/customers/cleanup" id="cleanup" class="btn btn-warning " title="Cleanup old customers"><i title="Cleanup old customers" class="fa fa-undo tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">Cleanup old customers</span></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row ">
            <form action="<?php echo base_url();?>index.php/customers/search" method="post" accept-charset="utf-8" id="search_form" autocomplete="off">					<input type="text" name ='search' id='search' value=""   placeholder="Search Customers"/>
            </form>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <span title="0 total customers" class="label label-info tip-left">0</span>
                        <a href="<?php echo base_url();?>index.php/customers/clear_state" class="btn btn-info btn-sm clear-state pull-right">clear search</a>
                    </div>
                    <div class="widget-content nopadding table_holder table-responsive" >
                        <table class="tablesorter table table-bordered  table-hover" id="sortable_table"><thead><tr><th class='leftmost'><input type="checkbox" id="select_all" /></th><th>Person ID</th><th>Last Name</th><th>First Name</th><th>E-Mail</th><th>Phone Number</th><th class='rightmost'>&nbsp</th></tr></thead><tbody><tr><td colspan='7'><span class='col-md-12 text-center text-warning' >There are no people to display</span></tr></tbody></table>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"653e27187f","applicationID":"2375780","transactionName":"bwdVbUoEVhcAAUUMDlZNdlpMDFcKTiFEFhVXD1JLS0pRCgUHSQ==","queueTime":0,"applicationTime":70,"ttGuid":"","agentToken":"","atts":"Q0BWGwIeRRk=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-593.min.js"}</script></body>
</html>